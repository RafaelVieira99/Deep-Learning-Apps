...
module DE2_115_SD_CARD_NIOS_mm_interconnect_1 (
		...
		input  wire        sd_clk_reset_reset_bridge_in_reset_reset,               //               sd_clk_reset_reset_bridge_in_reset.reset
	...
	wire  [83:0] sd_clk_s1_agent_rf_source_data;                                          // sd_clk_s1_agent:rf_source_data -> sd_clk_s1_agent_rsp_fifo:in_data
	...
	wire  [83:0] sd_clk_s1_agent_rsp_fifo_out_data;                                       // sd_clk_s1_agent_rsp_fifo:out_data -> sd_clk_s1_agent:rf_sink_data
	...
	wire  [82:0] cmd_mux_src_data;                                                        // cmd_mux:src_data -> sd_clk_s1_agent:cp_data
	wire         cmd_mux_src_ready;                                                       // sd_clk_s1_agent:cp_ready -> cmd_mux:src_ready
	wire   [4:0] cmd_mux_src_channel;                                                     // cmd_mux:src_channel -> sd_clk_s1_agent:cp_channel
	...
	wire  [83:0] sd_cmd_s1_agent_rf_source_data;                                          // sd_cmd_s1_agent:rf_source_data -> sd_cmd_s1_agent_rsp_fifo:in_data
	...
	wire  [83:0] sd_cmd_s1_agent_rsp_fifo_out_data;                                       // sd_cmd_s1_agent_rsp_fifo:out_data -> sd_cmd_s1_agent:rf_sink_data
	...
	wire  [82:0] cmd_mux_001_src_data;                                                    // cmd_mux_001:src_data -> sd_cmd_s1_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                   // sd_cmd_s1_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [4:0] cmd_mux_001_src_channel;                                                 // cmd_mux_001:src_channel -> sd_cmd_s1_agent:cp_channel
	...
	wire  [83:0] sd_dat_s1_agent_rf_source_data;                                          // sd_dat_s1_agent:rf_source_data -> sd_dat_s1_agent_rsp_fifo:in_data
	...
	wire  [83:0] sd_dat_s1_agent_rsp_fifo_out_data;                                       // sd_dat_s1_agent_rsp_fifo:out_data -> sd_dat_s1_agent:rf_sink_data
	...
	wire  [82:0] cmd_mux_002_src_data;                                                    // cmd_mux_002:src_data -> sd_dat_s1_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                   // sd_dat_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [4:0] cmd_mux_002_src_channel;                                                 // cmd_mux_002:src_channel -> sd_dat_s1_agent:cp_channel
	...
	wire  [83:0] sd_wp_n_s1_agent_rf_source_data;                                         // sd_wp_n_s1_agent:rf_source_data -> sd_wp_n_s1_agent_rsp_fifo:in_data
	...
	wire  [83:0] sd_wp_n_s1_agent_rsp_fifo_out_data;                                      // sd_wp_n_s1_agent_rsp_fifo:out_data -> sd_wp_n_s1_agent:rf_sink_data
	...
	wire         cmd_mux_003_src_valid;                                                   // cmd_mux_003:src_valid -> sd_wp_n_s1_agent:cp_valid
	wire  [82:0] cmd_mux_003_src_data;                                                    // cmd_mux_003:src_data -> sd_wp_n_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                   // sd_wp_n_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [4:0] cmd_mux_003_src_channel;                                                 // cmd_mux_003:src_channel -> sd_wp_n_s1_agent:cp_channel
	wire         cmd_mux_003_src_startofpacket;                                           // cmd_mux_003:src_startofpacket -> sd_wp_n_s1_agent:cp_startofpacket
	wire         cmd_mux_003_src_endofpacket;                                             // cmd_mux_003:src_endofpacket -> sd_wp_n_s1_agent:cp_endofpacket
	...
	wire  [83:0] timer_s1_agent_rf_source_data;                                           // timer_s1_agent:rf_source_data -> timer_s1_agent_rsp_fifo:in_data
	...
	wire  [83:0] timer_s1_agent_rsp_fifo_out_data;                                        // timer_s1_agent_rsp_fifo:out_data -> timer_s1_agent:rf_sink_data
	...
	wire  [82:0] cmd_mux_004_src_data;                                                    // cmd_mux_004:src_data -> timer_s1_agent:cp_data
	...
	wire  [82:0] clock_crossing_io_m0_agent_cp_data;                                      // clock_crossing_io_m0_agent:cp_data -> router:sink_data
	...
	wire  [82:0] sd_clk_s1_agent_rp_data;                                                 // sd_clk_s1_agent:rp_data -> router_001:sink_data
	...
	wire  [82:0] sd_cmd_s1_agent_rp_data;                                                 // sd_cmd_s1_agent:rp_data -> router_002:sink_data
	...
	wire  [82:0] sd_dat_s1_agent_rp_data;                                                 // sd_dat_s1_agent:rp_data -> router_003:sink_data
	...
	wire         sd_wp_n_s1_agent_rp_valid;                                               // sd_wp_n_s1_agent:rp_valid -> router_004:sink_valid
	wire  [82:0] sd_wp_n_s1_agent_rp_data;                                                // sd_wp_n_s1_agent:rp_data -> router_004:sink_data
	wire         sd_wp_n_s1_agent_rp_ready;                                               // router_004:sink_ready -> sd_wp_n_s1_agent:rp_ready
	wire         sd_wp_n_s1_agent_rp_startofpacket;                                       // sd_wp_n_s1_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire         sd_wp_n_s1_agent_rp_endofpacket;                                         // sd_wp_n_s1_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire  [82:0] timer_s1_agent_rp_data;                                                  // timer_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [82:0] router_src_data;                                                         // router:src_data -> clock_crossing_io_m0_limiter:cmd_sink_data
	...
	wire  [82:0] clock_crossing_io_m0_limiter_cmd_src_data;                               // clock_crossing_io_m0_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire  [82:0] rsp_mux_src_data;                                                        // rsp_mux:src_data -> clock_crossing_io_m0_limiter:rsp_sink_data
	...
	wire  [82:0] clock_crossing_io_m0_limiter_rsp_src_data;                               // clock_crossing_io_m0_limiter:rsp_src_data -> clock_crossing_io_m0_agent:rp_data
	...
	wire  [82:0] cmd_demux_src0_data;                                                     // cmd_demux:src0_data -> crosser:in_data
	...
	wire  [82:0] crosser_out_data;                                                        // crosser:out_data -> cmd_mux:sink0_data
	...
	wire  [82:0] cmd_demux_src1_data;                                                     // cmd_demux:src1_data -> crosser_001:in_data
	...
	wire  [82:0] crosser_001_out_data;                                                    // crosser_001:out_data -> cmd_mux_001:sink0_data
	...
	wire  [82:0] cmd_demux_src2_data;                                                     // cmd_demux:src2_data -> crosser_002:in_data
	wire         cmd_demux_src2_ready;                                                    // crosser_002:in_ready -> cmd_demux:src2_ready
	wire   [4:0] cmd_demux_src2_channel;                                                  // cmd_demux:src2_channel -> crosser_002:in_channel
	...
	wire  [82:0] crosser_002_out_data;                                                    // crosser_002:out_data -> cmd_mux_002:sink0_data
	wire         crosser_002_out_ready;                                                   // cmd_mux_002:sink0_ready -> crosser_002:out_ready
	wire   [4:0] crosser_002_out_channel;                                                 // crosser_002:out_channel -> cmd_mux_002:sink0_channel
	...
	wire  [82:0] cmd_demux_src3_data;                                                     // cmd_demux:src3_data -> crosser_003:in_data
	wire         cmd_demux_src3_ready;                                                    // crosser_003:in_ready -> cmd_demux:src3_ready
	wire   [4:0] cmd_demux_src3_channel;                                                  // cmd_demux:src3_channel -> crosser_003:in_channel
	...
	wire  [82:0] crosser_003_out_data;                                                    // crosser_003:out_data -> cmd_mux_003:sink0_data
	wire         crosser_003_out_ready;                                                   // cmd_mux_003:sink0_ready -> crosser_003:out_ready
	wire   [4:0] crosser_003_out_channel;                                                 // crosser_003:out_channel -> cmd_mux_003:sink0_channel
	...
	wire  [82:0] cmd_demux_src4_data;                                                     // cmd_demux:src4_data -> crosser_004:in_data
	wire         cmd_demux_src4_ready;                                                    // crosser_004:in_ready -> cmd_demux:src4_ready
	wire   [4:0] cmd_demux_src4_channel;                                                  // cmd_demux:src4_channel -> crosser_004:in_channel
	...
	wire  [82:0] crosser_004_out_data;                                                    // crosser_004:out_data -> cmd_mux_004:sink0_data
	wire         crosser_004_out_ready;                                                   // cmd_mux_004:sink0_ready -> crosser_004:out_ready
	wire   [4:0] crosser_004_out_channel;                                                 // crosser_004:out_channel -> cmd_mux_004:sink0_channel
	...
	wire         rsp_demux_src0_valid;                                                    // rsp_demux:src0_valid -> crosser_005:in_valid
	wire  [82:0] rsp_demux_src0_data;                                                     // rsp_demux:src0_data -> crosser_005:in_data
	wire         rsp_demux_src0_ready;                                                    // crosser_005:in_ready -> rsp_demux:src0_ready
	wire   [4:0] rsp_demux_src0_channel;                                                  // rsp_demux:src0_channel -> crosser_005:in_channel
	wire         rsp_demux_src0_startofpacket;                                            // rsp_demux:src0_startofpacket -> crosser_005:in_startofpacket
	wire         rsp_demux_src0_endofpacket;                                              // rsp_demux:src0_endofpacket -> crosser_005:in_endofpacket
	wire         crosser_005_out_valid;                                                   // crosser_005:out_valid -> rsp_mux:sink0_valid
	wire  [82:0] crosser_005_out_data;                                                    // crosser_005:out_data -> rsp_mux:sink0_data
	wire         crosser_005_out_ready;                                                   // rsp_mux:sink0_ready -> crosser_005:out_ready
	wire   [4:0] crosser_005_out_channel;                                                 // crosser_005:out_channel -> rsp_mux:sink0_channel
	wire         crosser_005_out_startofpacket;                                           // crosser_005:out_startofpacket -> rsp_mux:sink0_startofpacket
	wire         crosser_005_out_endofpacket;                                             // crosser_005:out_endofpacket -> rsp_mux:sink0_endofpacket
	wire         rsp_demux_001_src0_valid;                                                // rsp_demux_001:src0_valid -> crosser_006:in_valid
	wire  [82:0] rsp_demux_001_src0_data;                                                 // rsp_demux_001:src0_data -> crosser_006:in_data
	wire         rsp_demux_001_src0_ready;                                                // crosser_006:in_ready -> rsp_demux_001:src0_ready
	wire   [4:0] rsp_demux_001_src0_channel;                                              // rsp_demux_001:src0_channel -> crosser_006:in_channel
	...
	wire  [82:0] crosser_006_out_data;                                                    // crosser_006:out_data -> rsp_mux:sink1_data
	wire         crosser_006_out_ready;                                                   // rsp_mux:sink1_ready -> crosser_006:out_ready
	wire   [4:0] crosser_006_out_channel;                                                 // crosser_006:out_channel -> rsp_mux:sink1_channel
	...
	wire  [82:0] rsp_demux_002_src0_data;                                                 // rsp_demux_002:src0_data -> crosser_007:in_data
	wire         rsp_demux_002_src0_ready;                                                // crosser_007:in_ready -> rsp_demux_002:src0_ready
	wire   [4:0] rsp_demux_002_src0_channel;                                              // rsp_demux_002:src0_channel -> crosser_007:in_channel
	...
	wire  [82:0] crosser_007_out_data;                                                    // crosser_007:out_data -> rsp_mux:sink2_data
	wire         crosser_007_out_ready;                                                   // rsp_mux:sink2_ready -> crosser_007:out_ready
	wire   [4:0] crosser_007_out_channel;                                                 // crosser_007:out_channel -> rsp_mux:sink2_channel
	...
	wire  [82:0] rsp_demux_003_src0_data;                                                 // rsp_demux_003:src0_data -> crosser_008:in_data
	wire         rsp_demux_003_src0_ready;                                                // crosser_008:in_ready -> rsp_demux_003:src0_ready
	wire   [4:0] rsp_demux_003_src0_channel;                                              // rsp_demux_003:src0_channel -> crosser_008:in_channel
	...
	wire  [82:0] crosser_008_out_data;                                                    // crosser_008:out_data -> rsp_mux:sink3_data
	wire         crosser_008_out_ready;                                                   // rsp_mux:sink3_ready -> crosser_008:out_ready
	wire   [4:0] crosser_008_out_channel;                                                 // crosser_008:out_channel -> rsp_mux:sink3_channel
	...
	wire  [82:0] rsp_demux_004_src0_data;                                                 // rsp_demux_004:src0_data -> crosser_009:in_data
	wire         rsp_demux_004_src0_ready;                                                // crosser_009:in_ready -> rsp_demux_004:src0_ready
	wire   [4:0] rsp_demux_004_src0_channel;                                              // rsp_demux_004:src0_channel -> crosser_009:in_channel
	...
	wire  [82:0] crosser_009_out_data;                                                    // crosser_009:out_data -> rsp_mux:sink4_data
	wire         crosser_009_out_ready;                                                   // rsp_mux:sink4_ready -> crosser_009:out_ready
	wire   [4:0] crosser_009_out_channel;                                                 // crosser_009:out_channel -> rsp_mux:sink4_channel
	...
	wire         sd_clk_s1_agent_rdata_fifo_out_valid;                                    // sd_clk_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter:in_0_valid
	wire  [33:0] sd_clk_s1_agent_rdata_fifo_out_data;                                     // sd_clk_s1_agent_rdata_fifo:out_data -> avalon_st_adapter:in_0_data
	wire         sd_clk_s1_agent_rdata_fifo_out_ready;                                    // avalon_st_adapter:in_0_ready -> sd_clk_s1_agent_rdata_fifo:out_ready
	wire         avalon_st_adapter_out_0_valid;                                           // avalon_st_adapter:out_0_valid -> sd_clk_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_out_0_data;                                            // avalon_st_adapter:out_0_data -> sd_clk_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_out_0_ready;                                           // sd_clk_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire   [0:0] avalon_st_adapter_out_0_error;                                           // avalon_st_adapter:out_0_error -> sd_clk_s1_agent:rdata_fifo_sink_error
	wire         sd_cmd_s1_agent_rdata_fifo_out_valid;                                    // sd_cmd_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_001:in_0_valid
	wire  [33:0] sd_cmd_s1_agent_rdata_fifo_out_data;                                     // sd_cmd_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_001:in_0_data
	wire         sd_cmd_s1_agent_rdata_fifo_out_ready;                                    // avalon_st_adapter_001:in_0_ready -> sd_cmd_s1_agent_rdata_fifo:out_ready
	wire         avalon_st_adapter_001_out_0_valid;                                       // avalon_st_adapter_001:out_0_valid -> sd_cmd_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_001_out_0_data;                                        // avalon_st_adapter_001:out_0_data -> sd_cmd_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_001_out_0_ready;                                       // sd_cmd_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire   [0:0] avalon_st_adapter_001_out_0_error;                                       // avalon_st_adapter_001:out_0_error -> sd_cmd_s1_agent:rdata_fifo_sink_error
	wire         sd_dat_s1_agent_rdata_fifo_out_valid;                                    // sd_dat_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_002:in_0_valid
	wire  [33:0] sd_dat_s1_agent_rdata_fifo_out_data;                                     // sd_dat_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_002:in_0_data
	wire         sd_dat_s1_agent_rdata_fifo_out_ready;                                    // avalon_st_adapter_002:in_0_ready -> sd_dat_s1_agent_rdata_fifo:out_ready
	wire         avalon_st_adapter_002_out_0_valid;                                       // avalon_st_adapter_002:out_0_valid -> sd_dat_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_002_out_0_data;                                        // avalon_st_adapter_002:out_0_data -> sd_dat_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_002_out_0_ready;                                       // sd_dat_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire   [0:0] avalon_st_adapter_002_out_0_error;                                       // avalon_st_adapter_002:out_0_error -> sd_dat_s1_agent:rdata_fifo_sink_error
	wire         sd_wp_n_s1_agent_rdata_fifo_out_valid;                                   // sd_wp_n_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_003:in_0_valid
	wire  [33:0] sd_wp_n_s1_agent_rdata_fifo_out_data;                                    // sd_wp_n_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_003:in_0_data
	wire         sd_wp_n_s1_agent_rdata_fifo_out_ready;                                   // avalon_st_adapter_003:in_0_ready -> sd_wp_n_s1_agent_rdata_fifo:out_ready
	wire         avalon_st_adapter_003_out_0_valid;                                       // avalon_st_adapter_003:out_0_valid -> sd_wp_n_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_003_out_0_data;                                        // avalon_st_adapter_003:out_0_data -> sd_wp_n_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_003_out_0_ready;                                       // sd_wp_n_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire   [0:0] avalon_st_adapter_003_out_0_error;                                       // avalon_st_adapter_003:out_0_error -> sd_wp_n_s1_agent:rdata_fifo_sink_error
	wire         timer_s1_agent_rdata_fifo_out_valid;                                     // timer_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] timer_s1_agent_rdata_fifo_out_data;                                      // timer_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_004:in_0_data
	wire         timer_s1_agent_rdata_fifo_out_ready;                                     // avalon_st_adapter_004:in_0_ready -> timer_s1_agent_rdata_fifo:out_ready
	...
	altera_merlin_slave_translator #(
		...
		.reset                  (sd_clk_reset_reset_bridge_in_reset_reset), //                    reset.reset
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (altpll_c0_clk),                              //             clk.clk
		.reset                   (sd_clk_reset_reset_bridge_in_reset_reset),   //       clk_reset.reset
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.out_reset         (sd_clk_reset_reset_bridge_in_reset_reset),               // out_clk_reset.reset
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.in_reset          (sd_clk_reset_reset_bridge_in_reset_reset),               //  in_clk_reset.reset
	...
	DE2_115_SD_CARD_NIOS_mm_interconnect_0_avalon_st_adapter_001 #(
		...
		.in_rst_0_reset (sd_clk_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
