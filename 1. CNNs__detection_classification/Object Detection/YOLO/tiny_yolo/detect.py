...
if __name__ == "__main__":
	...
	parser.add_argument("--model_def", type=str, default=os.path.join('config','tinyv3.cfg'), help="path to model definition file")
	...
	for batch_i, (img_paths, input_imgs) in enumerate(dataloader):
		...
		for idx, img_detections in enumerate(detections):
			...
			img = cv2.imread(str(img_paths[idx]), cv2.IMREAD_COLOR)
